...
**
** Created: Thu Dec 20 16:15:21 2007
...
public:
    ...
    comboBox_filename->insertItems(0, QStringList()
     << QApplication::translate("Form", "Set Directory...", 0, QApplication::UnicodeUTF8)
    );
    ...
    label_resultat->setText(QApplication::translate("Form", "Risque obtenu : 0.05", 0, QApplication::UnicodeUTF8));
